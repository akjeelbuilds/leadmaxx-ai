    ...
    >
      ...
      {isSubmitted ? (
        ...
        <>
          ...
          {/* Application Form */}
          <form id="cardAuditForm" onSubmit={handleFormSubmit} className="space-y-4 relative z-10">
            {/* Global Error Banner */}
            {errorMsg && (
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="cardUserEmail" className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="cardUserNotes" className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
