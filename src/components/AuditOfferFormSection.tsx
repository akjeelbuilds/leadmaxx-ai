    ...
    >
      ...
      >
        ...
        <form id="auditForm" onSubmit={handleFormSubmit} className="space-y-4 relative z-10">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label htmlFor="businessName" className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
          ...
          <div>
            <label htmlFor="monthlyLeads" className="text-xs font-bold text-slate-300 flex items-center gap-1.5 mb-1.5">
